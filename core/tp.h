...
tp_inline static void tp_set_string(TP, tp_obj ob, const char* name, const char* value) {
    tp_set(tp, ob, tp_string(name), tp_string(value));
}

tp_inline static void tp_set_number(TP, tp_obj ob, const char* name, tp_num value) {
    tp_set(tp, ob, tp_string(name), tp_number(value));
}

tp_inline static void tp_set_func(TP, tp_obj ob, const char* name, tp_obj (*func)(TP)) {
    tp_set(tp, ob, tp_string(name), tp_fnc(tp, func));
}

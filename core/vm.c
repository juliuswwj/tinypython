...
void tp_builtins(TP) {
    ...
    {"str",tp_str2}, {"float",tp_float},
    {"istype",tp_istype}, {"chr",tp_chr},
    {"fpack",tp_fpack}, {"abs",tp_abs},
    {"int",tp_int}, {"exec",tp_exec_},
    {"number",tp_float}, {"round",tp_round},
